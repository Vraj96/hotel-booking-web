        ...
        <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                ...
                <div className='w-full mt-4'>
                    <lable htmlFor="name" className="font-medium text-gray-500" >
                        Hotel Name
                    </lable>
                ...
                {/* Phone */}
                <div className='w-full mt-4'>
                    <lable htmlFor="contact" className="font-medium text-gray-500" >
                        Phone Number
                    </lable>
                ...
                {/* Address */}
                <div className='w-full mt-4'>
                    <lable htmlFor="address" className="font-medium text-gray-500" >
                       Address
                    </lable>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    <lable htmlFor='city' className='font-medium text-gray-500' >
                        City
                    </lable>
