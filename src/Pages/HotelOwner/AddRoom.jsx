...
const AddRoom = () => {
  ...
  return (
    <form>
       <Title align='left' font='outfit' title='Add Room' subTitle='File in The details carefully and accurate room detaills, pricing, and amenities, to enhance the user booking experience.' /> 

       {/* Uplode Area For Image  */}
       <p className='text-gray-800 mt-10 '></p>
       ...
       <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
          ...
          <div>
            ...
            <input tupe="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={e => setInputs({...inputs,pricePerNight: e.target.value})} />
          </div>
       </div> 

       <p className='text-gray-800 mt-4'>Amenities</p>
       <div className='flex flex-col flex-wrap mt-1 text-gray-400 amx-w-sm'>
